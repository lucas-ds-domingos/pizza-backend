...
const ListOrdersControler_1 = require("./controllers/order/ListOrdersControler");
...
router.post('/session', new AuthUserController_1.AuthUserControlle().handle);
...
router.get('/orders', isAuthenticated_1.isAuthenticated, new ListOrdersControler_1.ListOrdersControler().handle);
